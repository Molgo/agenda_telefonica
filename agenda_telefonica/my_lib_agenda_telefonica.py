...
def editar_contato(lista_contatos, contato_selecionado, novo_nome, novo_telefone, novo_email):
    contato = lista_contatos[int(contato_selecionado) - 1]
    contato["nome"] = contato["nome"] if novo_nome == "0" else novo_nome
    contato["telefone"] = contato["telefone"] if novo_telefone == "0" else novo_telefone
    contato["email"] = contato["email"] if novo_email == "0" else novo_email
